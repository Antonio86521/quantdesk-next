...
function LoginForm() {
  ...
  /* ── MOBILE layout: single column, form on top ── */
  if (isMobile) {
    return (
      <div style={{
        minHeight: '100vh',
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: 'var(--fd)', fontWeight: 800, fontSize: 14, color: '#fff',
            boxShadow: '0 0 20px rgba(45,127,249,0.4)', flexShrink: 0,
          }}>QD</div>
          <div>
        ...
        <div style={{ flex: 1, padding: '28px 24px 40px', display: 'flex', flexDirection: 'column' }}>
          <div style={{ marginBottom: 28 }}>
            <h1 style={{ fontSize: 24, fontWeight: 700, letterSpacing: '-0.5px', marginBottom: 6, color: 'var(--text)' }}>Sign in</h1>
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <input
                ...
                autoComplete="email"
                autoFocus
                style={{ fontSize: 15, width: '100%', padding: '13px 14px' }}
              />
            </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{ fontSize: 15, paddingRight: 48, width: '100%', padding: '13px 48px 13px 14px' }}
                />
          ...
          {/* Features — collapsed on mobile, shown below form */}
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                <div style={{
                  ...
                  background: 'rgba(45,127,249,0.1)', border: '1px solid rgba(45,127,249,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                }}>
                  <Icon size={12} color="var(--accent2)" strokeWidth={1.5} />
                </div>
                <div style={{ fontSize: 12.5, color: 'var(--text2)' }}>{text}</div>
              </div>
            ))}
          </div>

          <div style={{ fontSize: 11, color: 'var(--text4)', marginTop: 'auto', paddingTop: 28 }}>
